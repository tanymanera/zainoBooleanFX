...
-- Dumping database structure for zaino
CREATE DATABASE IF NOT EXISTS `zaino` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `zaino`;

-- Dumping structure for table zaino.pezzo
CREATE TABLE IF NOT EXISTS `pezzo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_problema` varchar(5) NOT NULL DEFAULT '0',
  `peso` int(11) NOT NULL DEFAULT '0',
  `costo` int(11) NOT NULL DEFAULT '0',
  `ottimo` tinyint(4) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `FK_pezzo_problema` (`id_problema`),
  CONSTRAINT `FK_pezzo_problema` FOREIGN KEY (`id_problema`) REFERENCES `problema` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=83 DEFAULT CHARSET=utf8;

-- Dumping data for table zaino.pezzo: ~0 rows (approximately)
DELETE FROM `pezzo`;
...
-- Dumping structure for table zaino.problema
...
-- Dumping data for table zaino.problema: ~0 rows (approximately)
